...
figure('Renderer', 'painters', 'Position', [10 20 1600 600]);
cells=1:56'
cm=sqrt(rot90(Data.Average_VelNorth).^2+rot90(Data.Average_VelEast).^2);
[c,h]=contourf(Data.Average_Time,cells,cm,'LineStyle','none');
datetick('x','mmm-YY')
ylabel('Cell Number')
axis ij
c=colorbar; 
caxis([-0.1 0.1])
ylabel(c,'Current magnitude(m/s)')
cmocean('balance','pivot',0) 
grid on;
yticklabels('');
title('RHADCP-Nortek-S55. Deployed DY120, recovered JC238')
print(gcf,'-dpng','../figures/current magnitude');
